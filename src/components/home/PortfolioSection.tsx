              ...
              <motion.div
                ...
                <div
                  className={`w-[280px] rounded-2xl overflow-hidden transition-all duration-300 ${
                    isCenter
                      ? 'shadow-2xl ring-1 ring-white/30 dark:ring-white/20'
                  ...
                  <div className="p-4 bg-linear-to-b from-black/70 to-black/90">
                    ...
                    {isCenter && (
                      <motion.div
                        ...
                        className="mt-2 pt-3 border-t border-white/20 space-y-3">
                        <Link
                          href={`/portfolio/${project.id}`}
                          className="flex items-center justify-center w-full py-2 bg-white/10! hover:bg-white/20! rounded-lg text-sm font-medium transition-all duration-200 group">
                          <span className="text-white!">자세히 보기</span>
                          <svg
                            className="w-4 h-4 ml-1 group-hover:translate-x-1 transition-transform text-white!"
                            stroke="white"
                            viewBox="0 0 24 24">
                            <path
                              strokeLinecap="round"
